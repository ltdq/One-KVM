export default {
  ...
  settings: {
    ...
    atxLevelLow: '低电平有效',
    atxLedSensing: '状态检测',
    atxLedSensingDesc: '检测主机电源状态（可选，支持 LED GPIO 或开机卡）',
    atxStatusDriverNone: '禁用',
    atxStatusDriverLed: 'LED',
    atxStatusDriverMiot: '开机卡 (MiIoT)',
    atxLedEnable: '状态检测方式',
    atxLedEnableDesc: '选择电源状态检测的驱动类型',
    atxLedChip: 'GPIO 芯片',
    atxLedPin: 'GPIO 引脚',
    atxLedInverted: '反转逻辑',
    ...
    // MiIoT configuration
    atxMiot: 'MiIoT 连接设置',
    atxMiotDesc: '配置 MiIoT 设备连接参数（仅当按钮或状态检测驱动选择了「开机卡」时需要）',
    atxMiotProp: '属性 (prop)',
    atxMiotPropPlaceholder: '例如: on',
    atxMiotPropHint: 'MiIoT 设备属性名，例如 on、name',
    atxMiotValue: '值 (value)',
    atxMiotValuePlaceholder: '例如: True',
    atxMiotValueHint: '属性对应的开启值',
    atxMiotOffProp: '强制关机属性 (prop)',
    atxMiotOffPropPlaceholder: '例如: on',
    atxMiotOffPropHint: '强制关机时设置的属性名',
    atxMiotOffValue: '强制关机值 (value)',
    atxMiotOffValuePlaceholder: '例如: False',
    atxMiotOffValueHint: '强制关机时设置的属性值',
    atxMiotStatusProp: '状态属性 (prop)',
    atxMiotStatusPropPlaceholder: '例如: on',
    atxMiotStatusPropHint: '用于查询电源状态的 MiIoT 属性名',
    atxMiotStatusOnValue: '开机值',
    atxMiotStatusOnValuePlaceholder: '例如: True',
    atxMiotStatusOnValueHint: '表示「电源开启」的属性值',
    atxMiotStatusOffValue: '关机值',
    atxMiotStatusOffValuePlaceholder: '例如: False',
    atxMiotStatusOffValueHint: '表示「电源关闭」的属性值',
    atxMiotDid: '设备 DID',
    atxMiotDidPlaceholder: '例如: 2094828328',
    atxMiotDidHint: '米家设备的 Device ID，可通过 mijiaAPI 获取',
    atxMiotCommand: 'mijiaAPI 命令路径',
    atxMiotCommandPlaceholder: 'mijiaAPI',
    atxMiotCommandHint: 'mijiaAPI 的可执行文件路径，通常在 PATH 中可以直接使用命令名',
    atxMiotAuthPath: 'Auth 文件路径',
    atxMiotAuthPathPlaceholder: '例如: /path/to/auth.json',
    atxMiotAuthPathHint: '米家账号认证文件路径，保存时将执行 mijiaAPI -p <路径> 进行设置',
    // WOL configuration
