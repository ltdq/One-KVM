export default {
  ...
  settings: {
    ...
    atxDriverMiot: 'MiIoT Power Card',
    atxDevice: 'Device',
    atxPin: 'GPIO Pin',
    ...
    atxLedSensing: 'Status Detection',
    atxLedSensingDesc: 'Detect host power state (optional, supports LED GPIO or MiIoT Power Card)',
    atxStatusDriverNone: 'Disabled',
    atxStatusDriverLed: 'LED',
    atxStatusDriverMiot: 'MiIoT Power Card',
    atxLedEnable: 'Detection Method',
    atxLedEnableDesc: 'Choose the driver type for power status detection',
    atxLedChip: 'GPIO Chip',
    atxLedPin: 'GPIO Pin',
    atxLedInverted: 'Invert Logic',
    atxLedInvertedDesc: 'GPIO is low when LED is on',
    // MiIoT configuration
    atxMiot: 'MiIoT Connection Settings',
    atxMiotDesc: 'Configure MiIoT device connection (only required when a button or status driver is set to MiIoT Power Card)',
    atxMiotProp: 'Property (prop)',
    atxMiotPropPlaceholder: 'e.g. on',
    atxMiotPropHint: 'MiIoT device property name, e.g. on, name',
    atxMiotValue: 'Value',
    atxMiotValuePlaceholder: 'e.g. True',
    atxMiotValueHint: 'The "on" value for the property',
    atxMiotOffProp: 'Force Off Property (prop)',
    atxMiotOffPropPlaceholder: 'e.g. on',
    atxMiotOffPropHint: 'Property name for force power off',
    atxMiotOffValue: 'Force Off Value',
    atxMiotOffValuePlaceholder: 'e.g. False',
    atxMiotOffValueHint: 'Property value for force power off',
    atxMiotStatusProp: 'Status Property (prop)',
    atxMiotStatusPropPlaceholder: 'e.g. on',
    atxMiotStatusPropHint: 'MiIoT property to query for power status',
    atxMiotStatusOnValue: 'On Value',
    atxMiotStatusOnValuePlaceholder: 'e.g. True',
    atxMiotStatusOnValueHint: 'Value that means power is on',
    atxMiotStatusOffValue: 'Off Value',
    atxMiotStatusOffValuePlaceholder: 'e.g. False',
    atxMiotStatusOffValueHint: 'Value that means power is off',
    atxMiotDid: 'Device DID',
    atxMiotDidPlaceholder: 'e.g. 2094828328',
    atxMiotDidHint: 'MiIoT Device ID, obtainable via mijiaAPI',
    atxMiotCommand: 'mijiaAPI Command Path',
    atxMiotCommandPlaceholder: 'mijiaAPI',
    atxMiotCommandHint: 'Path to mijiaAPI executable, usually just the command name if in PATH',
    atxMiotAuthPath: 'Auth File Path',
    atxMiotAuthPathPlaceholder: 'e.g. /path/to/auth.json',
    atxMiotAuthPathHint: 'Path to MiIoT auth/token file. On save, mijiaAPI -p <path> will be executed to configure it.',
    // WOL configuration
